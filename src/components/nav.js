...
import NavGroupSvg from "./svg/NavGroupSvg";
        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          <div className="container-fluid">
            <Link to={"/"} className="navbar-brand logo">
              {context.darkMode ? (
                <img src="/img/logo-dm.png" alt="logo" />
              ) : (
            ...
            >
              <ul className="navbar-nav mb-2 mb-lg-0 align-items-center">
                ...
                <li
                  className={`nav-item br ${
                    window.location.pathname.includes("/polls") && "active"
                  }`}
                >
                ...
                <li
                  className={`nav-item br ${
                    window.location.pathname.includes("/stories") && "active"
                  }`}
                >
                ...
                <li className="nav-item d-flex align-items-center">
                  {context.darkMode ? (
                    <img
                      ...
                      className="theme"
                      onClick={() =>
                        setContext({ ...context, darkMode: false })
                      }
                    />
                  ) : (
                    <img
