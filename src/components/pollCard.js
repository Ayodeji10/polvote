...
function PollCard({ poll, pollVotes, liveVotes, fetchPolls }) {
    ...
    if (opened) {
        return (
            <OpenedPollCard poll={poll} liveVotes={liveVotes} pollVotes={pollVotes} setOpened={setOpened} fetchPolls={fetchPolls} />
        )
    }
        ...
        <div className="poll">
            <div className="row align-items-center">
                ...
                <div className="col-2 d-flex align-items-center">
                    <h6 id='open-poll' onClick={() => setOpened(true)}>Open Poll<i className="fa-solid fa-angle-down" /></h6>
                </div>
            </div>
        </div>
    )
