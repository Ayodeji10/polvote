...
function User() {
  ...
  const fetchCurrentUser = async () => {
    const response = await axios.get(`${API.API_ROOT}/users/singleuser/${id}`);
  ...
  const fetchFollowers = () => {
    axios
      .get(`${API.API_ROOT}/follow/followers/${id}`, {
        headers: {
          "content-type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("ballotbox_token")}`,
        },
  ...
  const fetchFollowing = () => {
    axios
      .get(`${API.API_ROOT}/follow/following/${id}`, {
        headers: {
          "content-type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("ballotbox_token")}`,
        },
  ...
  const unfollow = () => {
    ...
    axios
      .patch(
        `${API.API_ROOT}/follow/unfollow/${id}`,
        { followedid: id },
        {
          headers: {
            "content-type": "application/json",
              ...
              <div className="col-lg-9 col-12">
                <div className="user-main">
                  ...
                  <div className="bio">
                    <div className="d-flex justify-content-end mt-3 mb-lg-5 mb-md-4 mb-sm-3 mb-2">
                      ...
                      {!followersLoading && (
                        <>
                          {followers.filter(
                            (follower) =>
                              follower.followerid === context.user._id &&
                              follower.status === 0
                          ).length === 0 ? (
                    ...
                    <div className="row mb-lg-4 mb-md-3 mb-sm-3 mb-3 impresssions">
                      ...
                      <div className="col-lg-2 col-md-3 col-sm-3 col-4">
                        <h3>
                          {userTotalLikes}{" "}
                          <span>Like{userTotalLikes !== 0 && "s"}</span>
                        </h3>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6 col-4">
                        <h3>
                          {aspirants.length} <span>Aspirant Profiles</span>
                        </h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-between page-nav">
                    ...
                    <button
                      className={view === "aspirants" && "active"}
                      onClick={() => setView("aspirants")}
                    >
                      Aspirant Profiles
                    </button>
                    <button
