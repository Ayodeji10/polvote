                    ...
                    <div className="single-profile container">
                        <div className="row">
                                    ...
                                    <>
                                        ...
                                        <div className="stats mb-3">
                                            <div className="d-flex justify-content-between mb-2" onClick={() => {
                                                ...
                                                <h5>{!storyFetch &&
                                                    <>
                                                        {stories.filter(story => story.userid === context.user._id).length > 500 ? "500+" : stories.filter(story => story.userid === context.user._id).length}
                                                    </>
                                                }</h5>
                                            </div>
                                            <div className="d-flex justify-content-between mb-2" onClick={() => {
                            ...
                            <div className="col-lg-6 col-md-9 main">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-7 col-sm-7 col-12">
                                            <div className="searchbar d-flex align-items-center mb-lg-0 mb-md-0 mb-sm-0 mb-3">
                                                <input type="text" placeholder="Search for Aspirant Profile" value={context.homeSearchKey} onChange={(e) => setContext({ ...context, homeSearchKey: e.target.value })} />
                                ...
                                <iframe width="100%" height={350} src={aspirant.videourl.includes("watch") ? `https://www.youtube.com/embed/${aspirant.videourl.substring(32, 43)}` : `https://www.youtube.com/embed/${aspirant.videourl.substring(17, 28)}`} className="mb-4" title="YouTube video player" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen>
                                </iframe>
