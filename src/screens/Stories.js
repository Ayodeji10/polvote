                    ...
                    <div className="col-lg-8 story">
                        ...
                        <div className="create-story">
                            ...
                            <div className="d-flex justify-content-end">
                                <p className="mb-0 d-flex align-items-center"><img src="img/clarity_camera-solid.png" alt="image" /><span>Photo</span></p>
                                <p className="mb-0 d-flex align-items-center"><img src="img/link.png" alt="link" /><span>Attach
                                    link</span></p>
                            </div>
                        </div>
                        {/* stories  */}
