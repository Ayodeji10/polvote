...
const Login = () => {
  ...
  const verifyEmail = () => {
    ...
    axios
      .post(
        `${API.API_ROOT}/users/forgotpassword`,
  ...
  const handleNewPassword = () => {
    ...
    if (newPassword !== confirmPassword) {
      ...
      axios
        .patch(
          `${API.API_ROOT}/users/updatepassword/${localStorage.getItem(
            "temporaryId"
          )}`,
        ...
        <div className="container">
            ...
            <div>
              {context.darkMode ? (
                <img
                  ...
                  alt="theme"
                  className="theme"
                  onClick={() => setContext({ ...context, darkMode: false })}
                />
              ) : (
                <img
                  src="/img/theme.png"
                  alt="theme"
                  className="theme"
                  onClick={() => setContext({ ...context, darkMode: true })}
                />
              )}
              <button
                id="login-btn"
              ...
              >
                {view === "signup" || view === "main" ? "Login" : "Signup"}
              </button>
            </div>
          </header>
          <div className="row body justify-content-lg-between align-items-center">
            <div className="text col-lg-5 col-md-6 order-lg-1 order-md-1 order-sm-2 order-2 d-flex flex-column align-items-lg-end align-items-md-end align-items-sm-center align-items-center">
              ...
              <p>
                Polvote provides you with the ability to see profiles of
                Political Aspirants contesting for leadership, governance and
                economic positions near your locality. It also offers you a news
                feed which takes contributions from Political enthusiasts
                discussing simple to complex topics on social media including
                you. It also gives you the ability to vote for these aspiring
                leaders in contests created for the internet via Polvote.
              </p>
            </div>
            <div
              className={`order-lg-2 order-md-2 order-sm-1 order-1 ${
                view === "signup" ? "col-lg-6 col-md-6" : "col-lg-4 col-md-6"
              } `}
            >
              {/* main  */}
              {view === "main" && (
                <div className="main">
                  ...
                  <h5 className="mb-0" onClick={() => setView("login")}>
              ...
              {view === "login" && (
                <form className="login" onSubmit={(e) => handleLogin(e)}>
                  ...
                  <h6>
                    ...
                    <span onClick={() => setView("signup")}>Signup</span>
                  </h6>
                </form>
              )}
              {/* signup  */}
          ...
          <footer id="footer" className={`${context.darkMode ? "dm" : ""}`}>
            <div className="row">
              ...
              <div className="col-lg-4 col-md-5 col-sm-6 col-5 d-flex justify-content-lg-end justify-content-md-end justify-content-sm-end justify-content-between">
                <a
                  href="https://youtube.com/channel/UCkcn0Kv_w_Qe0MfZ7Hhe6lg"
                  target="_blank"
                >
                  <img
                    src="/img/youtube.png"
                ...
                <a
                  href="https://www.facebook.com/Polvoteofficial-115809974445682/"
                  target="_blank"
                >
                  <img src="/img/fb.png" alt="facebook" className="social" />
                </a>
                <a
                  href="https://www.instagram.com/polvoteofficial/"
                  target="_blank"
                >
                  <img
                    src="/img/insta.png"
                ...
                <a
                  href="https://twitter.com/pol_vote?t=iVqZBrU9MA793b4K1-YLwQ"
                  target="_blank"
                >
                  <img
                    src="/img/twitter.png"
      ...
      >
        ...
        <div className="content">
          ...
          {verificationView === "email" && (
            <>
              ...
              <button onClick={verifyEmail}>
                {verifyEmailLoading ? "loading..." : "Send"}
              </button>
            </>
          )}
          ...
          {verificationView === "otp" && (
            <>
              <i
                className="fa-solid fa-arrow-left-long otp-back"
                onClick={() => setVerificationView("email")}
              />
              <h2>Enter (OTP) One Time Password</h2>
              <p>
                Kindly check your email {verifyEmailInput}. Enter the OTP sent
                from Polvote,{" "}
                <span>
                  Also check your SPAM folder in case it didn't drop in your
                  Inbox
                </span>
              </p>
              <div className="otp-input d-flex justify-content-between">
          ...
          {verificationView === "reset" && (
            <>
              ...
              <button onClick={handleNewPassword}>
                {verifyEmailLoading ? "loading..." : "Reset Password"}
              </button>
            </>
          )}
